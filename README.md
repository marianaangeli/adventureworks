...
Preencha o arquivo .env com as credenciais de acesso (Host, Usuário, Senha, Banco de Dados). Nota: O arquivo .env está configurado no .gitignore para evitar a exposição de dados sensíveis.
